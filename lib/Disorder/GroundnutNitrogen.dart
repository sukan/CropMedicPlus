...
//                            AssetImage('assets/12.jpg'),
            ...
            Padding(
              ...
              child: Text('Yellowing or chlorosis appears first on the lower leaves; the upper leaves remain green. The tendency of the young upper leaves remaining green is due to the remaining nitrogen moving towards the newly growing leaves.', style: TextStyle(
                  fontSize: 17,
            ...
            Padding(
              padding: EdgeInsets.only(top: 20, bottom: 20, left: 14, right: 14),
              child: Text('NPK @ 40:40:60 kg/ha  as basal',
